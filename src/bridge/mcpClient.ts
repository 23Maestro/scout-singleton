...
export async function callNPIDTool(tool: string, args: Record<string, unknown> = {}): Promise<MCPResponse> {
...
export async function callAsanaTool(tool: string, args: Record<string, unknown> = {}): Promise<MCPResponse> {
...
export async function assignThread(messageId: string, assignee = "Jerami Singleton", status = "INBOX", stage = "Editing") {
...
export async function createVideoTask(playerName: string, sport: string, classYear: string, playerId: string, message: string, videoLinks: string[]) {
...
export async function getVideoTasks(statusFilter?: string, stageFilter?: string, assigneeFilter = "Jerami Singleton") {
